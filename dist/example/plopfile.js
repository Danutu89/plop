...
module.exports = function (plop) {
  ...
  plop.addHelper('dashAround', text => '---- ' + text + ' ----'); // formats an array of options like you would write
  ...
  plop.addPartial('salutation', '{{ greeting }}, my name is {{ properCase name }} and I am {{ age }}.'); // load some additional helpers from a module installed using npm
  ...
  plop.setGenerator('test', {
    ...
    actions: [`this is a comment`, 'this is another comment', delayLog('delayed thing'), delayLog('another delayed thing'), delayLog('this was also delayed'), {
      type: 'add',
      ...
      process.chdir(plop.getPlopfilePath()); // custom function can be synchronous or async (by returning a promise)
      ...
      var changeFilePath = plop.getDestBasePath() + '/folder/' + changeFileName; // you can use plop.renderString to render templates
